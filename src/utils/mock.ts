...
export const searchMenu = [
  ...
  { id:'blog', name: 'blog', active: false },
...
export const category = [
      ...
      { id:'personalization', name: 'Personalization', active: false },
      { id:'analytics', name: 'Analytics', active: false },
      { id:'instantSearch', name: 'InstantSearch', active: false },
      { id:' customers', name: ' Customers', active: false },
      { id:'pricing', name: 'Pricing', active: false },
      { id:'mobile-search', name: 'Mobile Search', active: false },
      { id:'e-commerce', name: 'E-commerce', active: false }
];
export const logo = [
  { id:'site-search',
